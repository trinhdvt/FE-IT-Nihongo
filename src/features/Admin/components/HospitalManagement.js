        ...
        const showListCode = result.map((item, index) => {
            return (
                <tr key={index}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-700 font-medium truncate w-36">{item.name}</div>
                    </td>

                    <td className="px-6 py-4 whitespace-nowrap">
                        <div className="text-sm text-gray-700 font-medium truncate w-36">{item.address}</div>
                    </td>
