...
function FormShowDetailUser(props) {
    ...
    return (
        <div className="flex absolute py-10 px-10 w-full h-full left-0 top-0 z-50 shadow rounded border border-gray-300 bg-white">
            <div className="w-1/3 ">
                <img src={user.avatarUrl} alt="" className="h-52 w-52 mt-10"/>
            </div>
            <div className="ml-10 w-2/3">
                ...
                <div className="mt-10">
                    <form className="form-create-user">
                        ...
                        <div className="mt-8 flex items-center">
                            <p className="font-medium w-1/3 text-gray-600">Role:</p>
                            <div className="w-full relative">
                                <input
                                    value={user.role}
                                    readOnly
...
export default FormShowDetailUser;